...
| DEF-012 | News, filings, fundamentals, macro, sector, and peer evidence adapters | A1 | DEPENDENCY_DEFERRAL | Production acquisition needs explicit source rights, identity, time, and quality semantics. | Source selection, licensing, identity, time and quality contracts | HIGH | A3 CLOSURE | DEFERRED | A3.4–A3.6 implement provider-neutral fundamental/event/sector/macro contracts, deterministic point-in-time normalization, controlled gateways, shared context reuse, and bounded caller-supplied/test adapters. Licensed production adapters remain; acquisition stays outside Agents. |
