...
| DEF-012 | News, filings, fundamentals, macro, sector, and peer evidence adapters | A1 | DEPENDENCY_DEFERRAL | Production acquisition needs explicit source rights, identity, time, and quality semantics. | Source selection, licensing, identity, time and quality contracts | HIGH | A3 CLOSURE | DEFERRED | A3.4 and A3.5 implement provider-neutral fundamental/event contracts, deterministic point-in-time normalization, controlled gateways, and bounded caller-supplied/test adapters. Licensed production fundamental/news/filing adapters plus macro/sector/peer acquisition remain; acquisition stays outside Agents. |
