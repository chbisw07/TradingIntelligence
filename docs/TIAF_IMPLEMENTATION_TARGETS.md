...
R1–R5 are ACCEPTED / DONE and A6 is ACTIVE / NEXT but NOT_IMPLEMENTED.
...
live hosting and remote transport remain separately gated. A6 architecture is next.
...
A5 is FROZEN and R1–R5 are closed. Current queue is A6 architecture/
