...
| FF-2 | CURRENT — FF-2.2 SYNTHETIC INFRASTRUCTURE IMPLEMENTED | [Data-use and qualification](TIAF_A7_FF2_1_DATA_USE_AUTHORITY_AND_PROSPECTIVE_EVIDENCE_QUALIFICATION.md); FF-2.2 synthetic infrastructure implemented; empirical authority next; empirical/final readiness NO |
