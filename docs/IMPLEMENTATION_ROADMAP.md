...
1. Follow [FF-2.1's handoff](TIAF_A7_FF2_1_DATA_USE_AUTHORITY_AND_PROSPECTIVE_EVIDENCE_QUALIFICATION.md#10-readiness-and-ff-22-handoff) for FF-2.2 synthetic-only calibration implementation.
