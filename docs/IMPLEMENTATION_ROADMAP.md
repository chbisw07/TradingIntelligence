...
1. Review [FF-2.2's implementation and handoff](TIAF_A7_FF2_2_SYNTHETIC_CALIBRATION_INFRASTRUCTURE.md); resolve empirical use authority before any real-data execution.
