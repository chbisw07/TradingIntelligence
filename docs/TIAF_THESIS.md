...
A7 ARCHITECTURE is ACCEPTED; FF-0 planning is COMPLETE; separately authorized FF-0.1 is NEXT. The intervening
...
FF MINIATURE REALIZATION is DEFINED; FF THESIS RECONCILED; FF ARCHITECTURE ACCEPTED; FFA-B01 CLOSED; A7 integration RECONCILED; A7 architecture ACCEPTED; FF-0 plan COMPLETE; separately authorized FF-0.1 NEXT,
...
FF-0 planning is complete; separately authorized FF-0.1 is next; implementation still needs separate authorization.
